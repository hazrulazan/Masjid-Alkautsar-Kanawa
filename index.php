        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center lg:text-left flex flex-col lg:flex-row items-center">
            <div class="lg:w-2/3">
                ...
                <p class="text-lg sm:text-xl text-gray-200 mb-10 max-w-2xl mx-auto lg:mx-0 anime-hero-desc" style="opacity: 0;">
                    Selamat datang di website resmi <?php echo htmlspecialchars($profileData['name'] ?? 'Masjid Al-Ikhlas'); ?>. Pusat kegiatan ibadah, pendidikan, dan sosial kemasyarakatan yang membawa rahmat bagi seluruh alam.
                </p>
    ...
    <section id="profil" class="py-20 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16 anime-fade-up">
                ...
                <h2 class="text-3xl sm:text-4xl font-extrabold text-gray-900 mt-2 mb-4">Profil <?php echo htmlspecialchars($profileData['name'] ?? 'Masjid Al-Ikhlas'); ?></h2>
