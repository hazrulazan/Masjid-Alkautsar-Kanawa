...
if (!isset($profileData) && !isset($profile)) {
    if (isset($pdo)) {
...
$adminTitleName = isset($profile['name']) ? $profile['name'] : (isset($profileData['name']) ? $profileData['name'] : 'Masjid Al-Ikhlas');
?>
<!DOCTYPE html>
<html lang="id">
<head>
    ...
    <title>Dashboard Admin - <?php echo htmlspecialchars($adminTitleName); ?></title>
    <!-- Tailwind CSS CDN -->
